...
export default function Home() {
  ...
  const checkBand = () => {
    ...
    else setResult("BAND 5: 0% Scholarship + Full Loan (Highest Income)");
  };
  ...
  return (
    <div style={{minHeight:"100vh", background:"#eef2f7", padding:20}}>
      <div style={{maxWidth:700, margin:"30px auto", background:"white", borderRadius:16, padding:24, boxShadow:"0 10px 30px rgba(0,0,0,0.1)"}}>
        ...
        <p style={{color:"#666", marginTop:4}}>Check your Funding Band instantly based on household income</p>
        
        <div style={{marginTop:20, display:"flex", gap:10}}>
          <Link href="/register" style={{background:"#0a3d62", color:"white", padding:"8px 14px", borderRadius:8, textDecoration:"none"}}>Go to Register</Link>
          <Link href="/calculator" style={{background:"#e67e22", color:"white", padding:"8px 14px", borderRadius:8, textDecoration:"none"}}>Go to Calculator</Link>
        </div>
